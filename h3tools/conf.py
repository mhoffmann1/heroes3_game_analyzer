...
if Frozen:
    ...
    PluginDirectory = os.path.join(getattr(sys, "_MEIPASS", ""), "h3tools", "plugins")
...
DownloadURL = "https://erki.lap.ee/downloads/h3tools/"
HomeUrl     = "https://suurjaak.github.io/h3tools"
